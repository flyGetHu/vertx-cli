...
public class MysqlHelperTest {
    ...
    public void update() {
        ...
        user.setName("name");
        user.setAge("age");
        Assertions.assertNotNull(MysqlHelper.update(user, null));
        Assertions.assertNotNull(MysqlHelper.update(user, DSL.and(DSL.field("id").eq(1))));
    }
...
//        Assertions.assertNotNull(MysqlHelper.select(User.class, DSL.and(DSL.field("id").eq(1))));
        Assertions.assertNotNull(MysqlHelper.select(User.class, DSL.and(DSL.field("id").eq(1)), List.of("id"), "limit 1"));
    }
}

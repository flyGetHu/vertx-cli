...
public class ApiResponse {
  ...
  public static Buffer successResponse(Object data) {
    return Json.encodeToBuffer(new ApiResponse(ApiResponseStatusEnum.OK, 200, "success", data, null));
  }

  public static Buffer successResponse(Object data, Object extra) {
    return Json.encodeToBuffer(new ApiResponse(ApiResponseStatusEnum.OK, 200, "success", data, extra));
  }

  public static Buffer errorResponse(String message) {
    return Json.encodeToBuffer(
        new ApiResponse(ApiResponseStatusEnum.ERROR, 500, message, null, null));
  }
